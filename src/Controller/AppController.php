...
class AppController extends Controller
{
    ...
    public function export()
    {
        ...
        $csvFilePath = "/var/www/html/adressbuchv2/webroot/download/Adressbuch_1854_all.csv";
        $sqlFilePath = '/var/www/html/adressbuchv2/webroot/download/Adressbuch_1854_all.sql';
