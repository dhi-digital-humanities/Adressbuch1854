...
<head>
    ...
    <?= $this->Html->css('http://cdnjs.cloudflare.com/ajax/libs/leaflet.markercluster/1.4.1/MarkerCluster.Default.css'); ?>
    <?= $this->Html->css('http://cdnjs.cloudflare.com/ajax/libs/leaflet.markercluster/1.4.1/MarkerCluster.css'); ?>
    <?= $this->Html->css('http://cdnjs.cloudflare.com/ajax/libs/leaflet.markercluster/1.4.1/leaflet.markercluster.css'); ?>
    ...
    <?= $this->Html->script('http://cdnjs.cloudflare.com/ajax/libs/leaflet.markercluster/1.4.1/leaflet.markercluster.js'); ?>
...
<body>
    ...
    <footer>
		<a target="_blank" href="https://www.dhi-paris.fr/">
			<?=$this->Html->image('logo-dhip.png', ['class' => 'wrapper-item', 'id' => 'dhi-logo', 'alt' => 'Logo DHIP', 'width' => '75px', 'height' => '37px'])?>
		</a>
